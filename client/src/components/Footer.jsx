const Footer = () => {
  return (
    <>
    <footer className="p-4 bg-white sm:p-6 dark:bg-[#031108]">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://juliaisasti.netlify.com" className="flex items-center">
                    <img src="/favicon.svg" className="mr-3 h-8" alt="Julia Isasti Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Julia Isasti</span>
                </a>
            </div>
